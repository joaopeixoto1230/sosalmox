      ...
      {migracaoGG15Pendente && (
        <div className="card border-blue-200 bg-blue-50 dark:border-blue-900/60 dark:bg-blue-950/40">
          ...
          <p className="text-xs text-blue-800/80 dark:text-blue-200/80 mt-1">
            Atualiza para BRG Geradores SLIM 110 (110kVA), motor FPT NEF 45, alternador WEG e
            números de série. Ano, painel, cor e horímetro não mudam. Confira o nº de série do
            motor na placa (manuscrito): 6249230.
          </p>
